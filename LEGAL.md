# Legal Notice — gitGost

## 1. Copyright

Copyright © 2024 livrasand. All rights reserved.

This software and all associated source code, documentation, design, and assets are protected under:

- **México:** Ley Federal del Derecho de Autor (LFDA), Diario Oficial de la Federación, 24 de julio de 1996, and its amendments.
- **International:** The Berne Convention for the Protection of Literary and Artistic Works (1886, as amended), to which Mexico is a signatory. Protection is automatically recognized in all 181+ member countries without registration.
- **United States:** The Digital Millennium Copyright Act (DMCA, 17 U.S.C.) and the Copyright Act of 1976, applicable to U.S.-based users and infrastructure.
- **European Union:** Directive 2001/29/EC on the harmonisation of certain aspects of copyright and related rights in the information society, applicable to EU-based users and contributors.

The author's moral rights (derechos morales), including the right of attribution and the right of integrity, are inalienable and perpetual under Mexican law and are recognized internationally.

---

## 2. License

gitGost is distributed under the **GNU Affero General Public License v3.0 (AGPL-3.0)**.

You may use, copy, modify, and distribute this software under the terms of the AGPL-3.0. If you operate a modified version of this software as a network service, you must make the complete corresponding source code available.
...
- Consequences arising from the use of the anonymous contribution infrastructure.
- Actions taken by third parties using this software to submit code to repositories.
- Any content submitted by users through the gitGost service.
...
**Content-related:**
- Submitting malicious code, malware, ransomware, spyware, or any 
  content intended to harm, surveil, or exploit third parties.
- Distributing, linking to, or referencing sexually explicit material, 
  including pornography or content that sexualizes minors in any form.
- Promoting, glorifying, or facilitating violence, terrorism, 
  self-harm, or harm to others.
- Content involving illegal weapons manufacturing, acquisition, 
  or modification.
- Content promoting or facilitating drug trafficking or illegal 
  substance distribution.
- Hate speech, discriminatory content, or material that degrades 
  individuals based on race, ethnicity, religion, gender, sexual 
  orientation, disability, or national origin.

**Operational/technical:**
- Circumventing security mechanisms, access controls, or rate limits 
  of target repositories or gitGost itself.
- Using gitGost as a vector to commit fraud, phishing, social 
  engineering, or identity theft.
- Automated abuse: bots, scrapers, or scripts designed to flood 
  repositories with spam contributions.

**Legal/ethical:**
- Harassing, defaming, doxxing, or targeting individuals or 
  organizations.
- Submitting content that infringes third-party intellectual property, 
  trade secrets, or confidentiality agreements.
- Any activity that violates applicable law in the user's jurisdiction 
  or in Mexico (governing jurisdiction of this software).

Violation of these terms may result in immediate blocking of the 
offending hash, removal of associated content from GitHub where 
technically feasible, and civil and/or criminal liability under 
...
For users located outside Mexico, nothing in this notice limits the rights granted to you under your local mandatory consumer or copyright laws.
...
*Last updated: 2024. This document does not constitute legal advice. Consult a qualified attorney for specific legal guidance.*
