...
// startBackground lanza `git-gost run <id>` como proceso independiente en su
// propio grupo de procesos, de modo que pause/resume/cancel puedan señalarlo.
...
// signalJob envía una señal a todo el grupo de procesos del job.
