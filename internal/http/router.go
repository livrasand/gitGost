...
func SetupRouter(cfg *config.Config) *gin.Engine {
	...
	api := r.Group("/api")
	{
		...
		api.GET("/users/search", UsersSearchHandler)
		api.GET("/code/search", CodeSearchHandler)
		api.GET("/github/packages/:owner", GitHubPackagesHandler)
		api.GET("/users/profile", UserProfileHandler)
		api.GET("/users/repos", UserReposHandler)
		api.GET("/users/readme", UserReadmeHandler)
